...
<form action="<?php echo JRoute::_('index.php?option=com_improvemycity&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
               ...
               <?php if (isset($this->items[0]->title)) { ?>
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_improvemycity&task=item.edit&id=' . $item->id); ?>">
						<?php echo $item->title; ?>
					</a>		
					<br />
				</td>
